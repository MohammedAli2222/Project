...
class PersonalCarRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'brand' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'string', 'max:255'],
            'model' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'string', 'max:255'],
            'gear_box' => [
            ...
            'vin' => [
                ...
                'max:17',
                'min:11',
                Rule::unique('personal_cars')->ignore($carId),
            ],
            'condition' => [
                $isUpdate ? 'sometimes' : 'required',
                'nullable',
            ...
            'price' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'numeric', 'min:0'],
            'currency' => ['sometimes', 'nullable', Rule::in(['SYR', 'USD'])],
            'negotiable' => ['sometimes', 'boolean'],
            'discount_percentage' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:100'],
            'discount_amount' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'horse_power' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'integer', 'min:1'],
            'engine_type' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'string', 'max:255'],
            'cylinders' => [$isUpdate ? 'sometimes' : 'required', 'nullable', 'integer', 'min:1'],
            ...
            'main_image_index' => ['sometimes', 'nullable', 'integer', 'min:0'],
            'available_status' => ['sometimes', 'nullable', Rule::in(['available', 'reserved', 'sold', 'rented'])],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'currency.in' => 'The currency must be either SYR or USD.',
